...
<?php $this->headlineText = "Shared files Statistics"; ?>
    ...
    <div>
        ...
        <div class="row inlinerow">
            ...
            echo CHtml::activeDropDownList($model, 'type', array(
                'file_number' => 'Number of files uploaded',
                'sample_size' => 'Average Sample Size',
                'archive_size' => 'Average Archive Size',
        ...
        <div class="row inlinerow">
            ...
            <?php echo CHtml::activeDropDownList($model, 'group', array('hour' => 'Hour', 'day' => 'Day', 'week' => 'Week', 'month' => 'Month'), array('style' => 'width: 105px;')); ?>
        </div>
        ...
        <div class="row inlinerow" style="margin:0;">
            ...
            <div class="row inlinerow">
                ...
                $this->widget('CJuiDatePicker', array(
                    'name' => 'PermanentFtpStatistics[start]',
                    'value' => $model->start,
            ...
            <div class="row inlinerow">
                ...
                <?php
                $this->widget('CJuiDatePicker', array(
                    'name' => 'PermanentFtpStatistics[end]',
                    'value' => $model->end,
                    // additional javascript options for the date picker plugin
                    'options' => array(
                        'changeMonth' => true,
    ...
    $(function() {
        ...
        $('#generateButton').click(function(){
            ...
            $.ajax({
                ...
                url: '/statistics/sharedfiles?ajaxGetChart=1',
                timeout: 5000,
        ...
        $('.dateShortcut').click(function(){
            $('#PermanentFtpStatistics_start').datepicker('setDate',$(this).attr('days'));
            $('#PermanentFtpStatistics_end').datepicker('setDate','-1');
            btnBg();
        });
