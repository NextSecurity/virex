<?php $this->headlineText = 'Bogus Samples'; ?>    
<script>
...
//			'name'=>'size_sne',
//			'filter'=>false,
//			'value'=>'FileHelper::formatSize($data->size_sne);',
//		    ),
        array(
            'name' => 'date_added_sne',
        ...
        array(
            ...
            'buttons' => array(
                ...
                'rescan' => array(
                    'label' => 'Rescan file',
                    'url' => 'Yii::app()->createUrl("/bogus/pending", array("idf"=>$data->id_sne, "status"=>"detected", "action"=>"rescan"))',
