...
CREATE TABLE IF NOT EXISTS `external_users_usr` (
  ...
  `second_public_gpg_key_text_usr` text NOT NULL,
  `second_public_gpg_key_name_usr` varchar(120) NOT NULL,
  PRIMARY KEY (`id_usr`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ;
...
CREATE TABLE IF NOT EXISTS `permanent_statistics_ftp_psf` (
  ...
  `files_number_psf` int(10) unsigned NOT NULL,
  `files_size_psf` int(10) unsigned NOT NULL,
  `archives_number_psf` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `permanent_statistics_user_psu` (
  ...
  `files_number_psu` int(10) unsigned NOT NULL,
  `files_size_psu` int(10) unsigned NOT NULL,
  `files_in_list_count_psu` int(10) unsigned NOT NULL,
  `files_unique_number_psu` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `samples_detected_sde` (
  ...
  `detection_sde` varchar(40) NOT NULL,
