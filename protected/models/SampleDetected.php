...
class SampleDetected extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('md5_sde, detection_sde, file_size_sde', 'required'),
            array('md5_sde', 'length', 'max' => 32),
            array('file_size_sde', 'length', 'max' => 10),
            array('detection_sde', 'length', 'max' => 20),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id_sde, md5_sde, type_sde, detection_sde, file_size_sde, added_when_sde, enabled_sde, pending_action_sde', 'safe', 'on' => 'search'),
        );
    }
